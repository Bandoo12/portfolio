...
export function CaseTabs() {
  ...
  return (
    <>
      <style>{`
        .ct-back:hover { color: rgba(255,255,255,0.85) !important; }
        .ct-tab:hover  { color: rgba(255,255,255,0.8)  !important; background: rgba(255,255,255,0.06) !important; }
      `}</style>
      <div style={{
        position: 'sticky', top: 0, zIndex: 100,
        background: 'rgba(4,4,8,0.72)', backdropFilter: 'blur(24px)',
        ...
        <Link href="/" className="ct-back" style={{
          ...
          fontSize: 13, marginRight: 24, flexShrink: 0, transition: 'color 0.2s',
        }}>
        ...
        {/* Divider */}
        <div style={{ width: 1, height: 20, background: 'rgba(255,255,255,0.1)', marginRight: 24, flexShrink: 0 }} />

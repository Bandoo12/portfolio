...
const IMG = {
  ...
  akbars:
    'https://s3-alpha-sig.figma.com/img/bb22/37a0/0d3dd8b8f6bdf28f00320e0029b48eb5?Expires=1783296000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=do1-jkbREXicV78s~dx5RYEyrvMwF-zV4MCRCPCpapenJoX1z-SF1jyEK0uFU-QAjTzPeMx7HgVzpsXCllEq4qCRQUUiFo82YuTQlfzTFW1gFeC9PhJF2MHsf1c4gizmOFTQr7wpJwirlZin7NPHbz0PNXE9eSBrjwmag~5zSXki~XXOQJMU1Rkuxv6hTOdZ9r28qPFcBzsG5pJ-Qaty8LGoOCCD34S6eazdamnHJviYThUPjhP7vAeNkjHYwbWvWbFZ4GGdHcGHiAWuBzV4gwzI6BT0ySRqRssSK3v6iNVTLFzrfofOKEfRS0yeQgcnQcS9~pfzKH~hJewPlQLi0A__',
  metal:
    'https://s3-alpha-sig.figma.com/img/7e4d/05cf/dd5ca01219cbaa2ce18f66972f743e45?Expires=1783296000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=Rlur9Yk1-iJSvcKZMWBfihI-X9CimzseWu1~vt~2yJ1ZPy7m318Z2QaRvkRftMnDXUJP6wzO5YVq2zzf4IXs-xX97h3JbLfI4LJZgfAiq1v1ANSLK8Z0rtpTsmc~nPMQyztRtvnJMfRws938KbQEGLTf95yt6wE~F~85O-RYb6YBHNdhaygB1gV73JWtQlzahYAP~UjptMAQ3I7tg5cxJ4mYe6bLvGd2yY2vuKTnq2h49fyjcj4qcXCI~354wHtSTuKY-J5elHoQGciZwwSWn3Ow-jxyRVrS3vOhj37ZLnEBytaLL8Ah9T6fleUXy-IBSs~yLVrqRHhLVqiEtgaMQQ__',
  inter:
    'https://s3-alpha-sig.figma.com/img/0a3a/b6f7/2e036a20e1aa93028733d59ce8ca8d68?Expires=1783296000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=HV8FztXvja-GC0KkyhPCQ8SY~pn2Qboi2U7~~3fWsZfBh96vmxv4nwNGQNmpmXgz5FpKWnZuqWqb9weuEKjWs5kNj02Ijo~-ak~ileGdZvbzBNUokLZkxQlpc4s817Q7BExTjFfXVoSm2tjeP9Qid75e4-jSoOkFSkycVN~TRebp24AYTjYDqcg8KKNqx8wBiShgi8PhucZQMqv9lpVj1s8PuTX8O76W--zADsCU8P1Bqm2rYGfgdmxzwZYngHYjHgDzqUdjYgPCXx8IOJ7nSwp8ThGbZWdMLY175uD5xL5mcuI-4FuRnNRswDjM-4lcI4CZuQUSxu2weE~FuXxuJg__',
  benfica:
    'https://s3-alpha-sig.figma.com/img/6ce0/dde2/596dc7851cd2e7770a1bbe4cee35cb1c?Expires=1783296000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=UBsngJy6Aqh6PcWzdykV60lgRLG9ClUTedq~ozPHteYoTLsPPKGkeefZNKoApRY0xdaHJ3R1QbitGDSwahn6u8CPaWUuMdauu77PeT3cfK4vcqsRRUh4E9RQAxbwuJkiJ2e154D75qKPPoLbXWqz8T-jBuQ8prAJa6EUkR~ktuKKHMSua-0Jfx70lzToZggXKrcgZWsaaiYjMggIwJw3ymse9KpUbr1FAPT01OY0-zJQU~I2qHoK-uMTUNsh-40Y1q0kU4VMo3SAfeG24cX6-tUK7PhCZ0RhyJo-IB2-2tEGKYZNo9kjlh2XiaAImRDj~Zp7ye34nFwOmzAdWSGGzw__',
  ska:
    'https://s3-alpha-sig.figma.com/img/b4ff/bd7c/aaf8ec01de6837449336e0c29ebce84a?Expires=1783296000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=Wsj-2~MmlVGFNJll75uNcJNAp2Ppn~O~JWy-7Wfk3WKjwCi0PBMv-tdxUEZtspJIIRRZe1GsXPT30WAdG3XJLbx2BPpqHKiYT9FleA2WrBpIaqEASJTp61ru840t6l7p2JHmKR8Fubrd1OT~5yECOL6D5F6onuYQi-uOvW9y8ijJQkQi0-fNm5zRMumGBnHIIEZybt3OBxfRQLkH37oAkyjtGYFEqqwTzALz9tBlgb7UxoOjzPKXRMa2x5yxh1Q__',
  russia:
    'https://s3-alpha-sig.figma.com/img/33ba/afa7/0006a8536fec966feb93791c9a7fce10?Expires=1783296000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=XIijZnGReJtxP~~CVMrzNDJbY45~QAgqBj8R~yC~tFFPc5AHEfNyRYs7k4c7fErSawzaOncjfkGRSobzu0haGmrJgbTgC~kq8VeDt6BfXhT51U0~WGTmShswAMOcIbZvIePBRTIVDhKuqqf3Vbt2xa5TCRJXeLwZ0rdMQ8vL9OV45NbmaSsSsBNJUHk-tB8AGhGne0kj8u1fAyW7T~sampj1NOygJkbl8KDKrCOoU9K2N~GGA~YsLJfih6tOwt5MNgPAK9lu-AOIsChLx9BxxAML6yZF4GXxLI9KOZj39Z1Y65eqvufLIuUNrz-V0WvDSy7BFUAi2ClSA3qjk2T2CWg__',
};
...
const CARDS = [
  { id: 1, type: 'yesno' as const, question: 'Будет угловой\nследующие',    timer: 28, start: 28, unit: 'секунд', period: 'в период 01:00–00:40', logo1: IMG.akbars, logo2: IMG.metal, odds1: '1.45', odds2: '2.80', pct1: '68%', pct2: '32%', label1: 'Да',      label2: 'Нет' },
  { id: 2, type: 'team'  as const, question: 'У кого будет мяч\nследующие', timer: 22, start: 13, unit: 'секунд', period: 'в период 01:00–00:40', logo1: IMG.akbars, logo2: IMG.metal, odds1: '1.65', odds2: '3.55', pct1: '75%', pct2: '25%', label1: 'АК Барс', label2: 'Металлург' },
  { id: 3, type: 'yesno' as const, question: 'Будет фол\nследующие',         timer: 25, start:  6, unit: 'секунд', period: 'в период 01:00–00:40', logo1: IMG.akbars, logo2: IMG.metal, odds1: '2.10', odds2: '1.80', pct1: '48%', pct2: '52%', label1: 'Да',      label2: 'Нет' },
  { id: 4, type: 'line'       as const, question: '', timer: 999999, start: 999999, unit: '', period: '', logo1: IMG.akbars, logo2: IMG.metal, odds1: '', odds2: '', pct1: '', pct2: '', label1: '', label2: '' },
  { id: 5, type: 'lineevent' as const, question: '', timer: 999999, start: 999999, unit: '', period: '', logo1: IMG.akbars, logo2: IMG.metal, odds1: '', odds2: '', pct1: '', pct2: '', label1: '', label2: '' },
];
...
// Continuous colour: green→amber→red as pct goes 1→0 (vivid, saturated)
...
// Continuous timer text colour: #91faba→#E0BE68→#FF6D6D
...
// Continuous pulse speed: 2.42s→1.32s→0.6s
...
function VirtualCard({ card, i, x, vIdx, onCanvasRef, onBet, activeBet, onClearBet, onExpire, isGhost, onExpireInactive, onBetPlaced, onBetWon }: {
  ...
  useEffect(() => {
    if (!betPlaced) return;
    const t = setTimeout(() => { setBetPlaced(false); setBetResult(true); onBetWon(); }, 15000);
    return () => clearTimeout(t);
  }, [betPlaced]);

  // When user swipes away from a won bet — silently remove it from the carousel
  useEffect(() => {
    if (betResult && !isActive && !isGhost) onExpireInactive(i);
  }, [isActive]); // eslint-disable-line react-hooks/exhaustive-deps

  // Countdown stops at 0 — expired state handled separately
  useEffect(() => {
  ...
  // After 2s in expired state (only real active card), trigger exit — but NOT if a bet is in progress
  useEffect(() => {
    if (!isExpired || !isActive || isGhost || betPlaced || betResult) return;
    onClearBet(); // close sheet immediately when card expires
  ...
  // Inactive real cards expire silently — no animation, invisible to user
  useEffect(() => {
  ...
  // Progressive scale/opacity/grayscale from drag position
  ...
  // Smooth glow colour: r,g,b animate every second → continuous gradient
  ...
  // Pulse loop reads speed via ref — changes speed per half-cycle, no restart
  ...
  useEffect(() => {
    ...
    if (card.type === 'line') {
      // Static glow — same visual style as other cards, no pulsing
  ...
  // Ellipse in selected chip mirrors the glow colour
  ...
  // Close keyboard when card becomes inactive or sheet closes
  useEffect(() => {
  ...
  // Permanent "next event" card — same visual structure as microbetting cards,
  // but no timer, no glow pulse, 5-button grid of outcomes instead of Da/Net
  if (card.type === 'line') {
    const lineEvents = [
      ...
      >
        ...
        >
          <div style={{ position: 'relative', isolation: 'isolate' }}>
            {/* Team header — identical to microbetting cards */}
            <div style={{ height: 50, borderRadius: '32px 32px 0 0', display: 'flex', alignItems: 'center', padding: '0 10px', gap: 4, position: 'relative', zIndex: 11 }}>
              <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: 4 }}>
                <span style={{ fontSize: 9, fontWeight: 400, color: '#eeeff3', textAlign: 'right' }}>АК Барс</span>
              ...
              <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 4 }}>
                ...
                <span style={{ fontSize: 9, fontWeight: 400, color: '#eeeff3', lineHeight: '12px' }}>Металлург{'\n'}Магнитогорск</span>
              </div>
            </div>

            {/* Video — same as other cards */}
            <motion.div
              initial={false}
              animate={{ height: 175 }}
            ...
            {/* Content — question + grid buttons, no timer */}
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        ...
                        <div onPointerDown={e => e.stopPropagation()} onClick={onClearBet} style={{ cursor: 'pointer', flexShrink: 0, pointerEvents: 'auto' }}>
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                            ...
                            <path d="M7 7L13 13M13 7L7 13" stroke="rgba(255,255,255,0.7)" strokeWidth="1.5" strokeLinecap="round"/>
                          </svg>
                        </div>
                      </div>
                    </motion.div>
                    ...
                    >
                      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                        {lineEvents.map((btn, bi) => (
                          <div
                            key={bi}
                            style={{ width: btn.full ? '100%' : 'calc(50% - 4px)', height: 62, background: 'rgba(0,0,0,0.65)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 24, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 18px', cursor: 'pointer', backdropFilter: 'blur(27px)', WebkitBackdropFilter: 'blur(27px)', position: 'relative', overflow: 'hidden' }}
                            onPointerDown={e => { e.stopPropagation(); onBet(btn.label, btn.odds); }}
                          >
            ...
            {/* Glow: green on betPlaced, static blue otherwise */}
        ...
        >
          ...
          <div style={{ background: '#171C1F', padding: '4px 8px 8px' }}>
            <div onClick={() => { if (activeBet) placedBetRef.current = { label: activeBet.label, odds: activeBet.odds }; setBetPlaced(true); onBetPlaced(); setBetAmount(0); setChipIdx(null); setKeyboardOpen(false); onClearBet(); }} style={{ height: 56, background: '#00a344', borderRadius: 20, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}>
              <span style={{ fontSize: 16, fontWeight: 700, color: '#ffffff' }}>Сделать ставку</span>
            </div>
          </div>
  ...
  // Line event card — П1/X/П2 + 1X/12/2X + CTA, same style as 'line' card
        ...
        >
          <div style={{ position: 'relative', isolation: 'isolate' }}>
            ...
            >
              ...
              <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: 34, zIndex: 12, pointerEvents: 'none', borderRadius: '0 0 32px 32px', background: 'linear-gradient(180deg, transparent 0%, rgba(0,0,0,0.6) 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 5 }}>
                <span style={{ fontSize: 10, fontWeight: 400, color: '#eeeff3', whiteSpace: 'nowrap', letterSpacing: -0.1 }}>Возможна задержка, можете переключиться на</span>
                <svg width="16" height="13" viewBox="258 11 16 13" fill="none"><path d="M271.574 23.875H261.657C260.095 23.875 258.824 22.6042 258.824 21.0417V13.9583C258.824 12.3957 260.095 11.125 261.657 11.125H271.574C273.136 11.125 274.407 12.3957 274.407 13.9583V21.0417C274.407 22.6042 273.136 23.875 271.574 23.875ZM272.99 13.9583C272.99 13.177 272.356 12.5417 271.574 12.5417H261.657C260.875 12.5417 260.24 13.177 260.24 13.9583V21.0417C260.24 21.823 260.875 22.4583 261.657 22.4583H271.574C272.356 22.4583 272.99 21.823 272.99 21.0417V13.9583ZM270.157 17.5C269.375 17.5 268.74 16.866 268.74 16.0833C268.74 15.3006 269.375 14.6667 270.157 14.6667C270.94 14.6667 271.574 15.3006 271.574 16.0833C271.574 16.866 270.94 17.5 270.157 17.5ZM263.782 17.5C263.39 17.5 263.074 17.1834 263.074 16.7917C263.074 16.4 263.39 16.0833 263.782 16.0833C264.174 16.0833 264.49 16.4 264.49 16.7917C264.49 17.1834 264.174 17.5 263.782 17.5ZM262.365 16.0833C261.974 16.0833 261.657 15.7667 261.657 15.375C261.657 14.9833 261.974 14.6667 262.365 14.6667C262.757 14.6667 263.074 14.9833 263.074 15.375C263.074 15.7667 262.757 16.0833 262.365 16.0833ZM265.199 18.9167C264.807 18.9167 264.49 18.6 264.49 18.2083C264.49 17.8166 264.807 17.5 265.199 17.5C265.59 17.5 265.907 17.8166 265.907 18.2083C265.907 18.6 265.59 18.9167 265.199 18.9167ZM268.032 18.9167C267.64 18.9167 267.324 18.6 267.324 18.2083C267.324 17.8166 267.64 17.5 268.032 17.5C268.424 17.5 268.74 17.8166 268.74 18.2083C268.74 18.6 268.424 18.9167 268.032 18.9167ZM266.615 20.3333C266.224 20.3333 265.907 20.0167 265.907 19.625C265.907 19.2333 266.224 18.9167 266.615 18.9167C267.007 18.9167 267.324 19.2333 267.324 19.625C267.324 20.0167 267.007 20.3333 266.615 20.3333Z" fill="#EEEFF3"/></svg>
              </div>
            </motion.div>

            {/* Content: section title + 3×2 grid (or selected bet) + CTA */}
                    ...
                    >
                      <div style={{ display: 'flex', flexWrap: 'wrap', rowGap: 6, columnGap: 8 }}>
                        {btns.map((btn, bi) => (
                          <div
                            key={bi}
                            style={{ width: 'calc((100% - 16px) / 3)', height: 62, background: 'rgba(0,0,0,0.65)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 24, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 4, cursor: 'pointer' }}
                            onPointerDown={e => { e.stopPropagation(); onBet(btn.l, btn.o); }}
                          >
                      ...
                      <div style={{ paddingTop: 12 }} onPointerDown={e => e.stopPropagation()}>
                        <div style={{ height: 56, background: 'transparent', border: '1px solid #8D9DCD', borderRadius: 24, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 18px', cursor: 'pointer', marginBottom: 0 }}>
  ...
  return (
    ...
    >
      <motion.div
        ...
        onAnimationComplete={() => { if (isExiting) onExpire(); }}
      >
      {/* Card body — overflow:hidden clips everything to rounded card shape */}
      <motion.div
        animate={{
          borderRadius: sheetOpen ? '32px 32px 24px 24px' : 32,
          background: sheetOpen ? '#171C1F' : '#121214',
        }}
        transition={{ duration: 0.25 }}
        style={{
          width: '100%',
          ...
          position: 'relative',
          overflow: 'hidden',
          scale: activeBet ? 1 : cardScale,
          opacity: activeBet ? 1 : cardOpacity,
          filter: activeBet ? 'grayscale(0)' : cardFilter,
          transformOrigin: origin,
        }}
      >
        {/* Inner wrapper — isolation:isolate keeps glow stacking context contained */}
        <div style={{ position: 'relative', isolation: 'isolate' }}>
        ...
        {/* Video — collapses when keyboard opens */}
        <motion.div
          initial={false}
          animate={{ height: keyboardOpen ? 0 : 175 }}
          transition={{ type: 'spring', stiffness: 340, damping: 34, mass: 0.9 }}
          style={{ position: 'relative', width: '100%', borderRadius: 32, overflow: 'hidden' }}
        >
          {/* Canvas container */}
          ...
          {/* Gradient and banner sit outside overflow:hidden → not clipped → full width */}
          <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: 80, background: 'linear-gradient(180deg, transparent 0%, rgba(0,0,0,0.6) 100%)', pointerEvents: 'none' }} />
          {/* eslint-disable-next-line @next/next/no-img-element */}
          {/* Delay banner — coded */}
          <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: 34, zIndex: 12, pointerEvents: 'none', borderRadius: '0 0 32px 32px', background: 'linear-gradient(180deg, transparent 0%, rgba(0,0,0,0.6) 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 5 }}>
        ...
        {/* Text + buttons — last 8px of bg transitions to sheet color so junction is invisible */}
        <div style={{ background: sheetOpen ? 'linear-gradient(#131214 calc(100% - 8px), #171C1F calc(100% - 8px))' : '#121214', borderRadius: sheetOpen ? 0 : '0 0 32px 32px', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '20px 8px 8px', minHeight: (betPlaced || betResult) ? 268 : sheetOpen ? 260 : 268 }}>
          ...
          <div style={{ width: '100%', marginTop: 'auto', paddingTop: 7, position: 'relative', zIndex: 11 }}>
            <AnimatePresence mode="wait" initial={false}>
              {activeBet ? (
                /* Gradient-bordered chip: wrapper is 1px gradient, inner is opaque dark */
                <motion.div
                  key="selected"
                  initial={{ opacity: 0, scale: 0.95 }}
                  animate={{ opacity: 1, scale: 1 }}
                  ...
                  style={{ position: 'relative', borderRadius: 24, height: 60, border: '1px solid rgba(255,255,255,0.35)', background: 'transparent', display: 'flex', alignItems: 'center', padding: '0 14px', justifyContent: 'space-between', overflow: 'hidden', pointerEvents: 'auto' }}
                >
                  {/* ellipse glow: centered horizontally, shifted below */}
                ...
                >
                  {[
                    { logo: card.logo1, odds: card.odds1, pct: card.pct1, label: card.label1 },
                    { logo: card.logo2, odds: card.odds2, pct: card.pct2, label: card.label2 },
                  ].map((btn, bi) => (
                    <div key={bi} onClick={() => onBet(btn.label, btn.odds, card.type === 'team' ? btn.logo : undefined)} onPointerDown={e => e.stopPropagation()} style={{ flex: 1, height: 80, background: 'rgba(0,0,0,0.65)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 28, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-start', paddingTop: 16, paddingBottom: 12, gap: 6, position: 'relative', backdropFilter: 'blur(27px)', WebkitBackdropFilter: 'blur(27px)', cursor: 'pointer' }}>
                      ...
                      {card.type === 'team' ? (
                        <div style={{ width: 38, height: 38, borderRadius: '50%', background: '#fff', overflow: 'hidden', flexShrink: 0 }}>
                      ...
                      <span style={{ fontSize: 10, fontWeight: 500, color: '#555f71', lineHeight: '12px', marginTop: 2 }}>{btn.odds}</span>
                    </div>
                  ))}
                </motion.div>
              )}
        ...
        {/* Active glow — fades out when expired; overridden green when bet placed */}
        ...
        {/* Expired glow — static gray inner shadow, fades in when expired */}
        <motion.div
          animate={{ opacity: isExpired ? 1 : 0 }}
          transition={{ duration: 0.6 }}
          style={{ position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 11, borderRadius: 32, boxShadow: 'inset 0px 20px 80px 8px rgba(38,38,38,1), inset 0px 0px 40px 1px rgba(63,63,63,1)' }}
        />
        </div>{/* end inner wrapper */}
      </motion.div>{/* end card body */}
        ...
        >
          ...
          <div
            ref={chipsRef}
            style={{ display: 'flex', gap: 6, flexWrap: 'nowrap', background: '#171C1F', padding: '12px 8px 4px', overflowX: 'auto', scrollbarWidth: 'none', cursor: 'grab', userSelect: 'none' }}
            onPointerDown={e => {
              e.stopPropagation();
              const el = chipsRef.current;
              if (!el) return;
            ...
            onPointerUp={() => {
              if (!chipsDrag.current?.moved && pressedChip.current !== null) {
                const CHIPS = [
                  ...
                  { value: 500 }, { value: 1000 }, { value: 5000 }, { value: 21214 },
                ];
                setChipIdx(pressedChip.current);
                setBetAmount(CHIPS[pressedChip.current].value);
              }
          ...
          >
            {[
              ...
              <div
                key={chip.label}
                onPointerDown={() => { pressedChip.current = idx; }}
          ...
          <div style={{ background: '#171C1F', padding: '8px 8px' }}>
            <div onClick={() => setKeyboardOpen(true)} style={{ height: 56, background: 'rgba(0,0,0,0.2)', borderRadius: 22, border: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', padding: '0 14px', gap: 8, cursor: 'text' }}>
              <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 5 }}>
                {betAmount === 0 && !keyboardOpen ? (
                  <span style={{ fontSize: 16, fontWeight: 400, color: '#555f71' }}>
                    Введите сумму
                  </span>
                ) : betAmount === 0 ? (
                  <span style={{ fontSize: 16, fontWeight: 600, color: '#eeeff3', display: 'flex', alignItems: 'center', gap: 0 }}>
                    0
                    <span style={{ display: 'inline-block', width: 2, height: 18, background: '#eeeff3', borderRadius: 1, marginLeft: 2, animation: 'cursor-blink 1s steps(1) infinite' }} />
                  </span>
                ) : (
                  <>
                    <span style={{ fontSize: 16, fontWeight: 600, color: '#eeeff3', display: 'flex', alignItems: 'center', gap: 0 }}>
                      {betAmount.toLocaleString('ru-RU')}
                      {keyboardOpen && <span style={{ display: 'inline-block', width: 2, height: 18, background: '#eeeff3', borderRadius: 1, marginLeft: 2, animation: 'cursor-blink 1s steps(1) infinite' }} />}
                    </span>
                    <svg width="12" height="10" viewBox="0 0 12 10" fill="none"><path d="M1 5H11M11 5L7.5 1M11 5L7.5 9" stroke="#929bae" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                    <span style={{ fontSize: 16, fontWeight: 600, color: '#929bae' }}>{activeBet ? Math.round(betAmount * parseFloat(activeBet.odds)).toLocaleString('ru-RU') : '—'}</span>
                  </>
          ...
          {/* Numeric keyboard — slides in below bet button */}
          <div style={{ padding: '4px 8px 8px', background: '#171C1F' }}>
            {([['1','2','3'],['4','5','6'],['7','8','9'],['','0','⌫']] as const).map((row, ri) => (
              <div key={ri} style={{ display: 'flex', gap: 4, marginBottom: ri < 3 ? 4 : 0 }}>
                {row.map((key, ci) => (
                  <div
                    ...
                    style={{
                      flex: key === '' ? 1 : 1,
                      height: 36,
                      background: key === '' ? 'transparent' : key === '⌫' ? 'rgba(255,255,255,0.06)' : '#24282F',
                      borderRadius: 8,
                      display: 'flex',
                      alignItems: 'center',
                  ...
                  >
                    {key === '⌫' ? (
                      <svg width="20" height="14" viewBox="0 0 20 14" fill="none">
                        <path d="M7.5 1H19V13H7.5L1 7L7.5 1Z" stroke="#929bae" strokeWidth="1.5" strokeLinejoin="round"/>
                        <path d="M12 5L16 9M16 5L12 9" stroke="#929bae" strokeWidth="1.5" strokeLinecap="round"/>
                      </svg>
                    ) : key !== '' ? (
                      <span style={{ fontSize: 20, fontWeight: 500, color: '#eeeff3', lineHeight: 1 }}>{key}</span>
                    ) : null}
                  </div>
                ))}
              </div>
      ...
      </motion.div>{/* end exit wrapper */}
    </motion.div>
  );
}

export default function MicrobetLive() {
  const sharedVideoRef = useRef<HTMLVideoElement>(null);
  const canvasEls = useRef<(HTMLCanvasElement | null)[]>([]);

  // Single parent-level RAF — always active, draws to ALL canvases every frame
  useEffect(() => {
  ...
  // Track current spring so stale .then() callbacks can be ignored
  const animCtrl   = useRef<{ stop: () => void } | null>(null);
  // Separate controller for the -7px centering shift when card expands 314→328
  const shiftCtrl  = useRef<{ stop: () => void } | null>(null);

  // When a bet is selected the active card widens 314→328px, shifting its visual center by +7px.
  // Compensate by shifting x -7px so the card stays centered throughout the animation.
  useEffect(() => {
    // Don't start a shift during an expire animation — let it complete first
  ...
  const snapTo = (v: number, instant = false) => {
    ...
    if (instant) {
      ...
      ctrl.then(() => {
        if (animCtrl.current !== ctrl) return; // stale — a newer snap already started
  ...
  const onDown = (e: React.PointerEvent) => {
    ...
    if (animCtrl.current) { animCtrl.current.stop(); animCtrl.current = null; }
    const curN = liveNRef.current;
    // If interrupted mid-loop-jump, teleport to real card so next drag starts from a valid position
  ...
  const onUp = (e: React.PointerEvent) => {
    if (!draggingRef.current) return; // ref check is sync — safe against cancel+up double-fire
    ...
    next = Math.max(0, Math.min(liveNRef.current + 1, next)); // clamp — prevents swiping past ghost cards
    snapTo(next);
  };
  ...
  const handleExpire = () => {
    ...
    if (newCards.length === 0) {
      ...
      // All cards expired — restart demo after short pause
      setTimeout(() => {
        const fresh = [...CARDS];
    ...
    // Slide next card in from the right, then seamlessly remove expired card
    const nextVIdx = currentVIdx + 1;
    const ctrl = animate(x, getX(nextVIdx), SPRING);
    animCtrl.current = ctrl;
    // Update ref for drag handling but NOT vIdx state — premature setVIdx would make the
    // next card "active" during the spring and trigger its active-expire countdown too early
    vIdxRef.current = nextVIdx;
    ctrl.then(() => {
      if (animCtrl.current !== ctrl) return;
      animCtrl.current = null;
      // Set x FIRST inside flushSync so Framer Motion's updateValue() fires with correct x
      // when React re-renders synchronously with new i props inside the same flushSync call
      flushSync(() => {
        x.set(getX(1));
        setLiveCards(newCards);
        setVIdx(1);
  ...
  const handleExpireInactive = (virtualIdx: number) => {
    ...
    const currentVIdx = vIdxRef.current;
    if (ri < currentVIdx - 1) {
      // Card left of current expired — shift vIdx down to keep same card visible
      ...
      // Card right of current expired — x and vIdx unchanged, just update cards
      setLiveCards(newCards);
    }
  };
    ...
    <div style={{ minHeight: '100vh', background: '#1c1c1e', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, sans-serif" }}>
      ...
      <div style={{ width: 360, height: 800, position: 'relative', overflow: 'hidden', borderRadius: 40 }}>
        ...
        <div style={{ position: 'absolute', top: 44, left: 0, right: 0, bottom: 0, background: '#0a0c0b', borderRadius: '32px 32px 0 0', display: 'flex', flexDirection: 'column', alignItems: 'center', overflow: 'hidden' }}>
          ...
          <div style={{ width: '100%', marginTop: 4, flexShrink: 0, overflow: 'hidden', position: 'relative', zIndex: 2 }}>
            ...
            >
              {liveVirtual.map((card, i) => {
                ...
                // When only the permanent card remains, hide side ghost duplicates
                if (liveN <= 1 && isGhost) return <div key={`${resetKey}-${keyPrefix}-empty`} style={{ width: CARD_W, flexShrink: 0 }} />;
                return (
                  <VirtualCard key={`${resetKey}-${keyPrefix}-${card.id}`} card={card} i={i} x={x} vIdx={vIdx} onCanvasRef={el => { canvasEls.current[i] = el; }} onBet={(label, odds, logo) => setSelectedBet({ label, odds, logo })} activeBet={selectedBet} onClearBet={() => setSelectedBet(null)} onExpire={handleExpire} isGhost={isGhost} onExpireInactive={handleExpireInactive} onBetPlaced={() => setBetsInPlay(n => n + 1)} onBetWon={() => setBetsInPlay(n => Math.max(0, n - 1))} />
                );
              })}
            </motion.div>
          </div>

          {/* Pagination dots — always show when no bet selected; single pill when only 1 card */}
          {!selectedBet && (
            <div style={{ marginTop: 8, display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 6, flexShrink: 0 }}>
              {liveCards.map((_, i) => (
          ...
          {/* Мои ставки — moves smoothly with sheet spring animation */}
          ...
          {[
            { team1: 'Интер Милан', team2: 'Бенфика',        logo1: IMG.inter, logo2: IMG.benfica, score: '0:0' },
            { team1: 'СКА',         team2: 'Россия (Олимп)', logo1: IMG.ska,   logo2: IMG.russia,  score: '1:2' },
            { team1: 'Интер Милан', team2: 'Бенфика',        logo1: IMG.inter, logo2: IMG.benfica, score: '0:0' },
          ].map((bet, i) => (
